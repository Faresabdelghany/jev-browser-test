  ...
  "steps": [
    {
      ...
      "action_deferred": { "operation": "TYPE_TEXT", "covered": 9 },  // a CLICK / TYPE_TEXT / SELECT below thresholds.covered_action_confidence while 9 controls sat under a blank layer: not executed, executed is a runner WAIT (settle_ms x 1, 2, 4, 4, 4 by "deferrals") ending when the page changes; flag DEFERRED-TYPE_TEXT:9
